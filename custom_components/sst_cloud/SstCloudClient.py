...
class SstCloudClient:
    ...
    def _populate_user_info(self):
        if self.user_data is None:
            ...
            self.postdata = {'username': self.username, 'password': self.password, 'email': self.email,
                             'language': 'ru'}
    ...
    def setTemperatureControllerFlag(self, homeid, deviceid, value=False):
    ...
    def setTemperatureControllerOn(self, homeid, deviceid):
        self.setTemperatureControllerFlag(homeid, deviceid, True)

    def setTemperatureControllerOff(self, homeid, deviceid):
        self.setTemperatureControllerFlag(homeid, deviceid, False)

    def setTemperatureManual(self, homeid, deviceid, temperature):
    ...
    def setMode(self, homeid, deviceid, mode):
    ...
    def getFullData(self, homeid):
        return self.full_data[homeid]